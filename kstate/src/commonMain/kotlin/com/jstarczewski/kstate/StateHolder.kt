...
/**
 * Classes that aim to provide an [State] that platforms can observe should implement this interface to allow easy binding
 * using auto-generated files for iOS. Implementing [StateHolder] is provides also a DSL for creating various [State] implementation.
 *
