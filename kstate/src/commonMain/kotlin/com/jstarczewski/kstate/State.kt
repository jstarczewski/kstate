 ...
 * represents a wrapper of type T which provides platform specific implementation allowing to receive update on target platforms
 * that happen during write operations from KMM shared module.
 */
